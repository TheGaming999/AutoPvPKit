...
public class KitsManager {
	...
	public void loadKits() {
		...
		kitsPath.getKeys(false).forEach(kitName -> {
			...
			helmetStack = new ItemStack(Material.matchMaterial(helmetItem), helmetAmount, helmetData);
			ItemMeta helmetMeta = helmetStack.getItemMeta();
			String helmetName = kitsPath.isSet(kitName + ".helmet.name") ? colorize(kitsPath.getString(kitName + ".helmet.name")) : null;
			List<String> helmetLore = kitsPath.isSet(kitName + ".helmet.lore") ? colorize(kitsPath.getStringList(kitName + ".helmet.lore")) : null;
			List<String> helmetEnchantments = kitsPath.isSet(kitName + ".helmet.enchantments") ? kitsPath.getStringList(kitName + ".helmet.enchantments"): null;
			List<String> helmetFlags = kitsPath.isSet(kitName + ".helmet.flags") ? kitsPath.getStringList(kitName + ".helmet.flags") : null;
			if(helmetName != null) {
			...
			chestplateStack = new ItemStack(Material.matchMaterial(chestplateItem), chestplateAmount, chestplateData);
			ItemMeta chestplateMeta = chestplateStack.getItemMeta();
			String chestplateName = kitsPath.isSet(kitName + ".chestplate.name") ? colorize(kitsPath.getString(kitName + ".chestplate.name")) : null;
			List<String> chestplateLore = kitsPath.isSet(kitName + ".chestplate.lore") ? colorize(kitsPath.getStringList(kitName + ".chestplate.lore")) : null;
			List<String> chestplateEnchantments = kitsPath.isSet(kitName + ".chestplate.enchantments") ? kitsPath.getStringList(kitName + ".chestplate.enchantments"): null;
			List<String> chestplateFlags = kitsPath.isSet(kitName + ".chestplate.flags") ? kitsPath.getStringList(kitName + ".chestplate.flags") : null;
			...
			leggingsStack = new ItemStack(Material.matchMaterial(leggingsItem), leggingsAmount, leggingsData);
			ItemMeta leggingsMeta = leggingsStack.getItemMeta();
			String leggingsName = kitsPath.isSet(kitName + ".leggings.name") ? colorize(kitsPath.getString(kitName + ".leggings.name")) : null;
			List<String> leggingsLore = kitsPath.isSet(kitName + ".leggings.lore") ? colorize(kitsPath.getStringList(kitName + ".leggings.lore")) : null;
			List<String> leggingsEnchantments = kitsPath.isSet(kitName + ".leggings.enchantments") ? kitsPath.getStringList(kitName + ".leggings.enchantments"): null;
			List<String> leggingsFlags = kitsPath.isSet(kitName + ".leggings.flags") ? kitsPath.getStringList(kitName + ".leggings.flags") : null;
			...
			bootsStack = new ItemStack(Material.matchMaterial(bootsItem), bootsAmount, bootsData);
			ItemMeta bootsMeta = bootsStack.getItemMeta();
			String bootsName = kitsPath.isSet(kitName + ".boots.name") ? colorize(kitsPath.getString(kitName + ".boots.name")) : null;
			List<String> bootsLore = kitsPath.isSet(kitName + ".boots.lore") ? colorize(kitsPath.getStringList(kitName + ".boots.lore")) : null;
			List<String> bootsEnchantments = kitsPath.isSet(kitName + ".boots.enchantments") ? kitsPath.getStringList(kitName + ".boots.enchantments"): null;
			List<String> bootsFlags = kitsPath.isSet(kitName + ".boots.flags") ? kitsPath.getStringList(kitName + ".boots.flags") : null;
			if(bootsName != null) {
			...
			itemsPath.getKeys(false).forEach(itemSlot -> {
				if(itemSlot.length() < 4) {
					...
					normalStack = new ItemStack(Material.matchMaterial(normalItem), normalAmount, normalData);
					ItemMeta normalMeta = normalStack.getItemMeta();
					String normalName = kitsPath.isSet(kitName + "." + itemSlot + ".name") ? colorize(kitsPath.getString(kitName + "." + itemSlot + ".name")) : null;
					List<String> normalLore = kitsPath.isSet(kitName + "." +  itemSlot + ".lore") ? colorize(kitsPath.getStringList(kitName + "." + itemSlot + ".lore")) : null;
					List<String> normalEnchantments = kitsPath.isSet(kitName + "." + itemSlot + ".enchantments") ? kitsPath.getStringList(kitName + "." + itemSlot + ".enchantments"): null;
					List<String> normalFlags = kitsPath.isSet(kitName + "." + itemSlot + ".flags") ? kitsPath.getStringList(kitName + "." + itemSlot + ".flags") : null;
					if(normalName != null) {
